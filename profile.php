                            ...
                            <div id="my-account-4" class="panel-collapse collapse <?php echo ((isset($_POST['add_address']) ||  isset($_POST['edit_address']) ||  isset($_POST['delete_address'])) ? 'show' : '') ?>">
                                <div class="panel-body">
                                    <div class="billing-information-wrapper">
                                            ...
                                            <div class="col-12 d-flex align-items-center justify-content-center">
                                                <div class="container">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <button name="add_address" class="form-group btn btn-primary my-2 offset-10">Add Address</button>
                                        ...
                                        <?php
                                        if (isset($_POST['edit_address']) && $_POST['street'] && $_POST['building'] && $_POST['flat'] && $_POST['floor'] && $_POST['detail'] && $_POST['region']) {
                                            $success = [];
                                            $errors = [];
                                                ...
                                                <div class="row">
                                                                        ...
                                                                        <select id="inputState" name="region" class="form-control">
                                                                            ...
                                                                            ?>
                                                                                    <optgroup label="<?php echo $value2['name'] ?>">
                                                                                        ...
                                                                                        if (!empty($result2)) {
                                                                                            $regions = $result2->fetch_all(MYSQLI_ASSOC);
                                                                                            foreach ($regions as $value3) {
                                                                                        ?>
                                                                                                <option <?php echo (($value3['id'] == $value['region_id']) ? 'selected' : ''); ?> value="<?php echo $value3['id'] ?>"><?php echo $value3['name']; ?></option>
                                                                                        <?php
                                                                                            }
                                                                                        }
                                                                                        ?>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center">
                                                        <div class="entries-edit-delete text-center">
                                                            ...
                                                            <button name="edit_address" class=" form-group btn btn-warning my-2 m-auto">Edit</button>
                                                            <button name="delete_address" class=" form-group btn btn-danger my-2 m-auto">Delete</button>
