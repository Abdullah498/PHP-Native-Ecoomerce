...
<div class="product-area gray-bg pt-90 pb-65">
	<div class="container">
		...
		<div class="row">
			...
			$result1 = $product1->getNewestProducts();
			if (!empty($result1)) {
				$allProducts1 = $result1->fetch_all(MYSQLI_ASSOC);
				foreach ($allProducts1 as $value1) {
			?>
					<div class="col-3">
						<div class="product-wrapper-single">
							<div class="product-wrapper mb-30">
								<div class="product-img">
								<a href="product-details.php?id=<?php echo $value1['id']?>">
										<img alt="" src="assets/img/product/<?php echo $value1['photo']?>">
									</a>
									<!-- <span>-30%</span> -->
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
								...
								<div class="product-content text-left">
									<div class="product-hover-style">
										<div class="product-title">
											<h4>
												<a href="product-details.php"><?php echo $value1['name']?></a>
											</h4>
										</div>
										<div class="cart-hover">
											<h4><a href="product-details.php">+ Add to cart</a></h4>
									...
									<div class="product-price-wrapper">
										<span><?php echo $value1['price']?> EGP</span>
										<span class="product-price-old"><?php echo $value1['price']?> EGP</span>
									</div>
								</div>
							</div>
						</div>
...
<div class="product-area gray-bg pt-90 pb-65 mt-5">
	<div class="container">
		<div class="product-top-bar section-border mb-55">
			<div class="section-title-wrap text-center">
		...
		<div class="row">
			...
			$result2 = $product2->getMostRatedProducts();
			if (!empty($result2)) {
				$allProducts2 = $result2->fetch_all(MYSQLI_ASSOC);
				foreach ($allProducts2 as $value2) {
			?>
					<div class="col-3">
						<div class="product-wrapper-single">
							<div class="product-wrapper mb-30">
								<div class="product-img">
								<a href="product-details.php?id=<?php echo $value2['id']?>">
										<img alt="" src="assets/img/product/<?php echo $value2['photo']?>">
									</a>
									<!-- <span>-30%</span> -->
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
								...
								<div class="product-content text-left">
									<div class="product-hover-style">
										<div class="product-title">
											<h4>
												<a href="product-details.php"><?php echo $value2['name']?></a>
											</h4>
										</div>
										<div class="cart-hover">
											<h4><a href="product-details.php">+ Add to cart</a></h4>
									...
									<div class="product-price-wrapper">
										<span><?php echo $value2['price']?> EGP</span>
										<span class="product-price-old"><?php echo $value2['price']?> EGP</span>
									</div>
								</div>
							</div>
						</div>
...
<div class="product-area gray-bg pt-90 pb-65 mt-5">
	<div class="container">
		...
		<div class="row">
			...
			$result3 = $product3->getMostOrderedProducts();
			if (!empty($result3)) {
				$allProducts3 = $result3->fetch_all(MYSQLI_ASSOC);
				foreach ($allProducts3 as $value3) {
			?>
					<div class="col-3">
						<div class="product-wrapper-single">
							<div class="product-wrapper mb-30">
								<div class="product-img">
								<a href="product-details.php?id=<?php echo $value3['id']?>">
										<img alt="" src="assets/img/product/<?php echo $value3['photo']?>">
									</a>
									<!-- <span>-30%</span> -->
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
								...
								<div class="product-content text-left">
									<div class="product-hover-style">
										<div class="product-title">
											<h4>
												<a href="product-details.php"><?php echo $value3['name']?></a>
											</h4>
										</div>
										<div class="cart-hover">
											<h4><a href="product-details.php">+ Add to cart</a></h4>
									...
									<div class="product-price-wrapper">
										<span><?php echo $value3['price']?> EGP</span>
										<span class="product-price-old"><?php echo $value3['price']?> EGP</span>
									</div>
								</div>
							</div>
						</div>
...
<div class="product-area gray-bg pt-90 pb-65 mt-5">
	<div class="container">
		...
		<div class="row">
			...
			$result4 = $product4->getMostViewedProducts();
			if (!empty($result4)) {
				$allProducts4 = $result4->fetch_all(MYSQLI_ASSOC);
				foreach ($allProducts4 as $value4) {
			?>
					<div class="col-3">
						<div class="product-wrapper-single">
							<div class="product-wrapper mb-30">
								<div class="product-img">
								<a href="product-details.php?id=<?php echo $value4['id']?>">
										<img alt="" src="assets/img/product/<?php echo $value4['photo']?>">
									</a>
									<!-- <span>-30%</span> -->
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
								...
								<div class="product-content text-left">
									<div class="product-hover-style">
										<div class="product-title">
											<h4>
												<a href="product-details.php"><?php echo $value4['name']?></a>
											</h4>
										</div>
										<div class="cart-hover">
											<h4><a href="product-details.php">+ Add to cart</a></h4>
									...
									<div class="product-price-wrapper">
										<span><?php echo $value4['price']?> EGP</span>
										<span class="product-price-old"><?php echo $value4['price']?> EGP</span>
									</div>
								</div>
							</div>
						</div>
