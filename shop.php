                    ...
                    <div class="product-grid product-view pb-20">
                        <div class="row">
                            ...
                            if (isset($_GET['sub']) && $_GET['sub']) {
                                $product->setSubcatId($_GET['sub']);
                                $result = $product->selectProductsBySubcatId();
                            } else {
                                        ...
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-content text-left">
                                                ...
                                                <div class="product-price-wrapper">
                                                    ...
                                                    <span class="product-price-old"><?php echo $value['price'] ?> EGP </span>
                                                </div>
                                            </div>
                                            <div class="product-list-details">
                                                ...
                                                <p>
                                                    <?php
                                                    $wordsCount = 50;
                                                    $detailsArray = str_word_count($value['detail'], 1);
