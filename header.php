                    ...
                    <div class="col-lg-9 col-md-8 col-6">
                        <div class="header-bottom-right">
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega-menu-position top-hover"><a>Categories</a>
                                            <ul class="mega-menu">
                                                <?php
                                                $category = new Category();
                                                $result = $category->selectData();
                                                if (!empty($result)) {
                                                ...
                                                ?>
                                                        <li>
                                                            <ul>
                                                                ...
                                                                <?php
                                                                    $subcategorey = new Subcategory();
                                                                    $subcategorey->setCategoryId($value['id']);
                                                                    $result2 = $subcategorey->getSubcatByCatId();
                                                                    if(!empty($result2)){
                                                                        $allSubcats = $result2->fetch_all(MYSQLI_ASSOC);
                                                                        
                                                                        foreach($allSubcats as $value2){
                                                                            ?>
                                                                                <li><a href='shop.php?sub=<?php echo $value2['id']?>'><?php echo $value2['name']?></a></li>
                                                                            <?php
                                                                        }
                                                                    }
                                                                ?>
                            ...
                            if (isset($_SESSION['user'])) {
                                ...
                                echo '<div class="header-currency">
                                        <span class="digit">Acount<i class="ti-angle-down"></i></span>
                                        <div class="dollar-submenu">
                                            <ul>
